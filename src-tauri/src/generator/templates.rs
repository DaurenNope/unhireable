...
impl TemplateManager {
    pub fn new() -> Result<Self> {
        ...
        // Resume templates (5 total)
        templates.insert(
            "resume_modern".to_string(),
            include_str!("templates/resume_modern.hbs").to_string(),
        );
        templates.insert(
            "resume_classic".to_string(),
            include_str!("templates/resume_classic.hbs").to_string(),
        );
        templates.insert(
            "resume_executive".to_string(),
            include_str!("templates/resume_executive.hbs").to_string(),
        );
        templates.insert(
            "resume_technical".to_string(),
            include_str!("templates/resume_technical.hbs").to_string(),
        );
        templates.insert(
            "resume_creative".to_string(),
            include_str!("templates/resume_creative.hbs").to_string(),
        );

        // Cover letter templates (5 total)
        templates.insert(
            "cover_letter_professional".to_string(),
            include_str!("templates/cover_letter_professional.hbs").to_string(),
        );
        templates.insert(
            "cover_letter_casual".to_string(),
            include_str!("templates/cover_letter_casual.hbs").to_string(),
        );
        templates.insert(
            "cover_letter_formal".to_string(),
            include_str!("templates/cover_letter_formal.hbs").to_string(),
        );
        templates.insert(
            "cover_letter_friendly".to_string(),
            include_str!("templates/cover_letter_friendly.hbs").to_string(),
        );
        templates.insert(
            "cover_letter_concise".to_string(),
            include_str!("templates/cover_letter_concise.hbs").to_string(),
        );
