...
export const restAnswerPatternsApi = {
    get: (personaId = 'default') => restCall(`/api/answer-patterns?persona_id=${encodeURIComponent(personaId)}`),
    save: (config, personaId = 'default') => restCall(`/api/answer-patterns?persona_id=${encodeURIComponent(personaId)}`, {
        method: 'PUT',
