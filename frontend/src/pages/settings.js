...
function EmailNotificationSettings() {
    ...
    const [fromName, setFromName] = useState("JobEz");
    ...
    useEffect(() => {
        ...
        if (savedConfig) {
            try {
                ...
                setFromName(config.from_name || "JobEz");
