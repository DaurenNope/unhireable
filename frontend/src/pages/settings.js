...
export function Settings() {
    ...
    return (_jsxs("div", { className: "space-y-6 p-6", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-3xl font-bold tracking-tight", children: "Settings" }), _jsx("p", { className: "text-muted-foreground", children: "Configure your profile, automation, and preferences." })] }), _jsxs(Tabs, { value: defaultTab, onValueChange: (value) => {
                ...
                }, className: "space-y-4", children: [_jsxs(TabsList, { children: [_jsx(TabsTrigger, { value: "profile", children: "Profile" }), _jsx(TabsTrigger, { value: "automation", children: "Automation" }), _jsx(TabsTrigger, { value: "scraper", children: "Job Sources" }), _jsx(TabsTrigger, { value: "credentials", children: "API Keys" }), _jsx(TabsTrigger, { value: "patterns", children: "Answer Patterns" }), _jsx(TabsTrigger, { value: "preferences", children: "Preferences" }), _jsx(TabsTrigger, { value: "appearance", children: "Appearance" })] }), _jsx(TabsContent, { value: "profile", className: "space-y-4", children: _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Your Profile" }), _jsx(CardDescription, { children: "Your skills, experience, and preferences help us match you with the right jobs." })] }), _jsx(CardContent, { children: _jsx(ProfileSettings, {}) })] }) }), _jsx(TabsContent, { value: "automation", className: "space-y-4", children: _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Automation" }), _jsx(CardDescription, { children: "Configure automatic job applications, email notifications, and scheduling." })] }), _jsxs(CardContent, { className: "space-y-6", children: [_jsx(AutomationHealthCard, {}), _jsx(ApplicationSettings, {}), _jsx(Separator, {}), _jsx(EmailNotificationSettings, {}), _jsx(Separator, {}), _jsx(SchedulerSettings, {})] })] }) }), _jsx(TabsContent, { value: "scraper", className: "space-y-4", children: _jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Job Sources" }), _jsx(CardDescription, { children: "Choose which job boards to scrape and how often to check for new listings." })] }), _jsx(CardContent, { className: "space-y-6", children: _jsx(ScraperSettings, {}) })] }) }), _jsx(TabsContent, { value: "credentials", className: "space-y-4", children: _jsx(CredentialsSettings, {}) }), _jsx(TabsContent, { value: "patterns", className: "space-y-4", children: _jsx(AnswerPatternsSettings, {}) }), _jsx(TabsContent, { value: "preferences", className: "space-y-4", children: _jsx(JobPreferences, {}) }), _jsx(TabsContent, { value: "appearance", className: "space-y-4", children: _jsx(AppearanceSettings, {}) })] })] }));
}
const DEFAULT_ANSWER_PATTERNS = {
    patterns: [
...
function AnswerPatternsSettings() {
    ...
    const saveMutation = useMutation({
        mutationFn: (config) => restApi.answerPatterns.save(config, "default"),
        onSuccess: () => {
    ...
    if (isLoading) {
        return (_jsx(Card, { children: _jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Answer Patterns" }), _jsx(CardDescription, { children: "Loading..." })] }) }));
    }
    if (error) {
        return (_jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Answer Patterns" }), _jsx(CardDescription, { children: "Could not load patterns. Is the app running? The extension will use bundled defaults." })] }), _jsx(CardContent, { children: _jsx(Button, { onClick: () => refetch(), variant: "outline", children: "Retry" }) })] }));
    }
    return (_jsxs(Card, { children: [_jsxs(CardHeader, { children: [_jsx(CardTitle, { children: "Answer Patterns" }), _jsx(CardDescription, { children: "Map form questions to your profile or fixed values. Used by the Chrome extension for auto-fill. Add patterns for common questions; the extension falls back to LLM or asks you for unknowns." })] }), _jsxs(CardContent, { className: "space-y-4", children: [_jsxs("div", { className: "flex gap-2", children: [_jsx(Button, { onClick: handleLoadDefaults, variant: "outline", size: "sm", children: "Load defaults" }), _jsxs(Button, { onClick: handleSave, disabled: saveMutation.isPending, children: [saveMutation.isPending ? _jsx(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }) : _jsx(Save, { className: "mr-2 h-4 w-4" }), "Save"] })] }), parseError && (_jsxs(Alert, { variant: "destructive", children: [_jsx(AlertCircle, { className: "h-4 w-4" }), _jsx(AlertDescription, { children: parseError })] })), _jsxs("div", { className: "space-y-2", children: [_jsx(Label, { children: "Patterns (JSON)" }), _jsx("textarea", { className: "min-h-[400px] w-full rounded-md border border-input bg-background px-3 py-2 font-mono text-sm", value: jsonText, onChange: (e) => setJsonText(e.target.value), placeholder: '{"patterns": [...]}' })] })] })] }));
}
...
function AutomationHealthCard() {
    ...
    return (_jsxs(Card, { children: [_jsxs(CardHeader, { className: "flex flex-row items-center justify-between", children: [_jsxs("div", { children: [_jsx(CardTitle, { children: "Automation Health Check" }), _jsx(CardDescription, { children: "Run this before enabling auto-apply to ensure everything is ready." })] }), _jsxs(Button, { variant: "outline", size: "sm", onClick: () => refetch(), disabled: isFetching, children: [_jsx(RefreshCw, { className: cn("mr-2 h-4 w-4", isFetching && "animate-spin") }), "Refresh"] })] }), _jsx(CardContent, { className: "space-y-4", children: isLoading && !health ? (_jsx("p", { className: "text-sm text-muted-foreground", children: "Running checks..." })) : (_jsxs(_Fragment, { children: [_jsx(HealthRow, { label: "Profile completeness", ok: profileReady, description: profileReady
                                ...
                                : "Browser runtimes will be detected automatically." }), _jsx(HealthRow, { label: "PinchTab (external apply)", ok: Boolean(health?.pinchtab_available), description: health?.pinchtab_available
